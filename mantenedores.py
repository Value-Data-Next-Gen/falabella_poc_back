...
# ============================================================================
# Empresa documents + Vehicle documents (mismo modelo que driver_documents)
# ============================================================================
...
def _enforce_vehicle_access(user: CurrentUser, vehicle_id: int) -> None:
    if user.is_falabella:
        return
    with get_conn() as cn:
        cur = cn.cursor()
...
def list_vehicle_documents(vehicle_id: int,
                            user: CurrentUser = Depends(require_fleet_access)) -> list[EntityDocOut]:
    _enforce_vehicle_access(user, vehicle_id)
    with get_conn() as cn:
        cur = cn.cursor()
        cur.execute(
